...
(function(){
  ...
  window.completeTrip=function(){
    ...
    const ok=window.confirm((typeof TRIP_CONFIG!=='undefined'&&TRIP_CONFIG.admin&&TRIP_CONFIG.admin.completeMessage)||'Complete this trip? All trip content will remain available to browse, but editing will be disabled until the trip admin reopens the trip.');
    if(!ok) return false;
