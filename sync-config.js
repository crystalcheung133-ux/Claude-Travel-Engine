...
(function(root){
  ...
  const config=Object.freeze({
    ...
    cacheKey:root.STORAGE_CONFIG.keys.cloudSnapshot,
    metadataKey:root.STORAGE_CONFIG.keys.cloudSyncMeta,
    reloadMarkerKey:root.STORAGE_CONFIG.keys.cloudReloadMarker,
    autoRead:true
  });
