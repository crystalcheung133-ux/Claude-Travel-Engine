...
assert.match(cfg,/mode:\s*'admin'/,'NZ/default must remain admin-managed');
assert.match(perms,/collaborative/,'collaborative mode missing');
...
console.log('PASS booking collaboration foundation');
