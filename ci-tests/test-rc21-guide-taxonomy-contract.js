...
const expected=["openGuideCategory('ATTRACTIONS')","openGuideCategory('DINING')","openGuideCategory('WELLNESS')","openGuideCategory('EXPERIENCES')","openGuideCategory('STAY')","openGuideCategory('SHOP')"];
...
console.log('RC21 Guide taxonomy contract PASS');
