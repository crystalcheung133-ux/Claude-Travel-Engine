...
const d1=I['1'].items,d2=I['2'].items,d3=I['3'].items;assert.equal(d1.find(x=>x.id==='qspa-d1').time,'~12:15–14:15');assert.equal(d2.find(x=>x.id==='qspa-d2').time,'~14:15–16:15');assert.equal(d3.find(x=>x.id==='qspa-d3').time,'~17:15–19:15');
