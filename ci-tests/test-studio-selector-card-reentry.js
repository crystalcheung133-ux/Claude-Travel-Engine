...
if(!a.includes("studio.scrollIntoView({block:'start',inline:'nearest'})")) fail.push('Studio card positional targeting missing');
if(a.includes("sheet.scrollTop + (studioRect.top - sheetRect.top)")) fail.push('reentry must not depend on .guide-sheet being the scroll container (RC25.4.28 made it non-scrolling for the combined view)');
