...
const sd=fs.readFileSync('shopping-directory-data.js','utf8');assert(sd.includes('Day 1 · Nguyễn Trãi Walk'));assert(sd.includes('Day 2 · Trần Quang Diệu Walk'));assert(sd.includes('Day 4 · Thảo Điền'));
