...
assert(B['bk-qspa']&&B['bk-qspa'].plannedDays==='D1 · D2 · D3');assert.deepEqual(ids(4),['running-bean','pink-church','push-push','thao-dien-open-list']); assert(I['4'].items[3].details.some(x=>x.includes('120 分鐘')));
