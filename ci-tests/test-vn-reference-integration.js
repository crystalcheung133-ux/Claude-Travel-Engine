...
assert.match(data,/"cashbackStatus": "tracked"/,'Fusion ShopBack tracked state missing');
assert.match(data,/"roomType": "Two-Bedroom Executive"/,'Fusion room type missing');
