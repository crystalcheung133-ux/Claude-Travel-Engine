...
if(!css.includes('padding-top:calc(var(--studio-status-height,52px) + var(--studio-traveller-header-height,68px))!important')) fail.push('page/workspace must clear both rows');
