# Travel Engine deployment — Post-Trip Analytics Instructions
...
```sql
where trip_id = '<TRIP_ID>' and actor_type = 'traveller'
```
...
-- Before vs during vs after trip (trip dates 22 Sep–1 Oct 2026)
select case
