...
(function(root){
  ...
  const keys=Object.freeze({
    ...
    momentPrefix:namespace+':moment:',
    latestMomentPrefix:namespace+':moment_latest:',
    momentsFreeform:namespace+':moments_freeform:v1',
    momentsList:namespace+':moments_list:v1',
    friend:'nz_friend',
